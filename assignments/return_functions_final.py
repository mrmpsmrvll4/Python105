...
print = int(input("Enter the Principal Amount":  ))
print = int(input("Enter the Interest Rate as a whole number:  "))
print = int(input("Enter the Investment Time in whole years:  "))
