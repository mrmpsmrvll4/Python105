...
Python Programming Assignment: Password Validator

In this assignment, you will create a Python program that prompts the user to enter a password and validates it against specific criteria.

Assignment Outline:
-------------------
1. Set up your program in a main() function
2. Create a Python program that asks the user to input a password.
...
4. Use a while loop to keep asking for the password until all criteria are met.
5. Once a valid password is entered, prompt the user to enter it again for confirmation.
6. Use try-except blocks to handle any errors or exceptions that occur.
7. If the second password entry matches the first, display a success message. Otherwise, prompt the user to start the process again.
